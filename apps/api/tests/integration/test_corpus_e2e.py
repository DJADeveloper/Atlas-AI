"""M04 acceptance E2E (nightly): 1,000 mixed files ingest unattended.
...
async def test_thousand_file_corpus_ingests_unattended(
    ...
    try:
        ...
        ingest = IngestDocument(
            uow_factory=uow, file_store=LocalFileStore(), parser_for=registry.parser_for
        )
        ...
        results = [
            (await ingest.execute(workspace_id, job_id)).result
